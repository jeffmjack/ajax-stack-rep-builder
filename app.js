...
// takes a string of semi-colon separated tags use for finding
// top answerers on StackOverflow
...
var showAnswerer= function(item) {
  ...
  // set the questions answered  
  var questionsAnswered= result.find('.questionsAnswered');
  questionsAnswered.text(item.post_count);
